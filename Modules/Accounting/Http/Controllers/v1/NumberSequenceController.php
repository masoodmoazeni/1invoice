...
{
    protected $numberSequencepService;

    public function __construct(NumberSequenceService $numberSequencepService)
    {
        $this->numberSequencepService = $numberSequencepService;
    }
    /**
