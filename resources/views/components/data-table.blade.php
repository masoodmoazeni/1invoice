	...
	<div class="card-body pt-0">
		<div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
			<div class="table-responsive">
				<table class="table align-middle table-row-bordered fs-6 gy-5 dataTable no-footer" id="kt_customers_table">
					<thead>
					<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
						...
						@endphp
						@if($hasActionColumn)
							<th class="text-center   actions-th">{{ __('messages.global.table.action') }}</th>
						@endif
						<th>#</th>
						...
						<tr>
							@if($hasActionColumn && !empty($actions))
                                <td class="text-center  actions-td">
                                    <a href="#" class="btn btn-icon  btn-active-color-success btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                        {{--	{{ __('messages.global.label.option') }}--}}
                                        <i class=" icon-there-dot"></i>
                                    </a>
					...
					@empty
						<tr>
							<td colspan="{{ count($headers) + ($hasActionColumn && !empty($actions) ? 1 : 0) + ($hasPagination ? 1 : 0) }}"
