        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:24px;text-align:center;border-bottom:1px solid #eee;">
              <p style="margin:0;color:#6b7280;font-size:14px;">Listing Approved</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                {{ $is_broker ? 'The' : 'Your' }} listing <strong>#{{ $listing_id }}, {{ $listing_title }}</strong> is
                now live on Salonspa Connection’s website!
              </p>
