...
<head>
  ...
  <title>Listing Send For Admin Approval</title>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:24px;text-align:center;border-bottom:1px solid #eee;">
              <p style="margin:0;color:#6b7280;font-size:14px;">Listing Send For Admin Approval</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                Your listing <strong>#{{ $listing_id }}, {{ $listing_title }}</strong>  is ready and has been sent for admin approval.
              </p>

              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                You can view and manage your listing and account by logging into your account:
              </p>
