          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                Welcome to Salonspa Connection, we are glad to have you! Please reset your password using the link below
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                Access your Salonspa Connection account: <a href="{{ $confirmation_link }}"
                  style="color:#0F4F6B;text-decoration:none;">{{ $confirmation_link }}</a>
              </p>
