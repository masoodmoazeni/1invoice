...
<head>
  ...
  <title>New consultant inquiry</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding:24px;text-align:center;border-bottom:1px solid #eee;">
              <p style="margin:0;color:#6b7280;font-size:14px;">New inquiry</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:28px 32px;">
              <h1 style="margin:0 0 12px;font-size:20px;color:#0f172a;">
                Hi there, {{ $consultant_first_name }}!
              </h1>

              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                We wanted to let you know that <strong>{{ $inquirer_full_name }}</strong> is interested in speaking with you. Their information is below!
              </p>
              ...
              <div style="background:#f9fafb;border-radius:6px;padding:20px;margin:20px 0;">
                ...
                <p style="margin:8px 0;color:#374151;font-size:14px;">
                  <strong>Services they are interested in:</strong> {{ $services_interested ?: '—' }}
                </p>

                <p style="margin:8px 0;color:#374151;font-size:14px;">
                  <strong>How you can best serve them:</strong> {{ $how_can_best_serve ?: '—' }}
                </p>
              </div>

              <p style="margin:0 0 22px;color:#374151;font-size:16px;line-height:1.5;">
                Make sure to keep your profile up to date in order to keep getting interest from new potential customers!
              </p>
