...
<head>
  ...
  <title>Consultant Profile Created</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding:24px;text-align:center;border-bottom:1px solid #eee;">
              <p style="margin:0;color:#6b7280;font-size:14px;">Salonspa Connection Coach/Consultant Profile Created</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                This email is to confirm you have created a profile as a consultant/coach for the beauty industry. Thank you for sharing your expertise on Salonspa Connection.
              </p>

              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                You can update your profile at any time and will receive emails whenever you receive a new lead!
              </p>
