...
<head>
  ...
  <title>You're Invited to Salonspa Connection</title>
</head>
          ...
          <tr>
            <td style="padding:28px 32px;">
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                You've been invited to join Salonspa Connection! We're excited to have you on board. Please click the link below to accept your invitation and set up your account.
              </p>
              ...
              <p style="margin:0 0 18px;color:#374151;font-size:16px;line-height:1.5;">
                Access your invitation link: <a href="{{ $invitation_link }}" style="color:#0F4F6B;text-decoration:none;">{{ $invitation_link }}</a>
              </p>
